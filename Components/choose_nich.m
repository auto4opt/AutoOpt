...
% Adaptive niching based on the nearest-better clustering [1][2]. 
% Crossover (if available) will be conducted between solutions from the same specie.
% -------------------------------------------------------------------------
% [1] Preuss M. Niching the CMA-ES via nearest-better clustering[C]//
% Proceedings of the 12th annual conference companion on Genetic and 
% evolutionary computation. 2010: 1711-1718.
% [2] Yan B, Zhao Q, Li M, et al. Fitness landscape analysis and niching 
