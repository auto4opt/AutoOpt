...
switch Setting.Mode
    case 'design'
        ...
        % xlswrite('Algs.xlsx', firstRow,'sheet',sheetName,'xlRange','A1');
        ...
        % xlswrite('Algs.xlsx', allCode,'sheet','Best Algs at Iteration');
    ...
    case 'solve'
        ...
        % xlswrite('Solutions.xlsx', constraint,'sheet','Constraint Violation','xlRange','A1');
        ...
        % xlswrite('Solutions.xlsx', fitnessAll,'sheet','Fitness of All Runs','xlRange','A1');
