function [output1,output2,output3] = CEC2013_f27(varargin)
% The f27 Function from the benchmark for the CEC 2013 Special
...
switch varargin{end}
    ...
    case 'evaluate'
        ...
        z         = 6*x_shifted*Ms(1:D,1:D)*constructLambda(100,D);
        ...
        g_vals(:,i1) = sum_term - cos_terms + 1;
        ...
        z         = 10*( (x_shifted * Ms(2*D+1:i3*D,1:D)) * constructLambda(10,D) ) + 4.209687462275036e+002; 
        g_sum = zeros(N,1);
        for i = 1:D
            zi = z(:,i);
            abs_zi = abs(zi);
