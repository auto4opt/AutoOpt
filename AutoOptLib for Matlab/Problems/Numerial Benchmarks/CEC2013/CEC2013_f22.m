function [output1,output2,output3] = CEC2013_f22(varargin)
% The f22 Function from the benchmark for the CEC 2013 Special
...
switch varargin{end}
    ...
    case 'evaluate'
        ...
        z         = 10*( x_shifted * constructLambda(10,D) ) + 4.209687462275036e+002;  % (N×D)
        g_sum = zeros(N,1);
        for i = 1:D
            zi = z(:,i);
            abs_zi = abs(zi);
