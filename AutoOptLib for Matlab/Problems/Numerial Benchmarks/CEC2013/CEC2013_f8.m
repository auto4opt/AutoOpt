function [output1,output2,output3] = CEC2013_f8(varargin)
% The f8 Function from the benchmark for the CEC 2013 Special
   ...
   case 'repair'
    ...
    case 'evaluate'
        ...
        for i = 1:D
            z = Decs(:,i);
            term1 = term1 + z.^2 / D;
            term2 = term2 + (cos(2 * pi * z) / D);
        end
        term1 = -20*exp(-0.2*sqrt(term1));
        term2 = -exp(term2);
