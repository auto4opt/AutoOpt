...
for i = 21:numIterations
    try
        ...
        % 调用 AutoOpt 函数
        AutoOpt('Mode', mode, 'Problem', problem, 'InstanceSolve', instanceSolve, 'AlgName', AlgName);
